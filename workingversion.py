...
import io
import base64
from typing import Dict, List, Tupleimport streamlit as st
import pandas as pd
import duckdb
import requests
import json
        ...
        html += f"""
                <div class="agent-card">
                    <div class="agent-header" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <a href="{mailto_link}" style="display: inline-flex; align-items: center; gap: 6px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 8px 16px; border-radius: 20px; text-decoration: none; font-weight: 600; font-size: 0.85rem; transition: all 0.3s ease; box-shadow: 0 3px 8px rgba(102, 126, 234, 0.3);" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 5px 12px rgba(102, 126, 234, 0.4)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 3px 8px rgba(102, 126, 234, 0.3)';">
                            📧 Share
                        </a>
                    </div>
